...
class Validator extends GUMP
{
    ...
    public function get_readable_errors($convert_to_string = false, $field_class="field", $error_class="error-message")
    {
        ...
        foreach($this->errors as $e) {
            ...
            if(array_key_exists($e['field'], $this->labels)) {
                $field = $this->labels[$e['field']];
            }

            $field = "<span class='{$field_class}'>{$field}</span>";

            switch($e['rule']) {
                case 'mismatch' :
                    $resp[] = sprintf(__("There is no validation rule for \"%s\""), $field);
                    break;
                case 'validate_required':
                    $resp[] = sprintf(__("The \"%s\" field is required"), $field);
                    break;
                case 'validate_valid_email':
                    $resp[] = sprintf(__("The \"%s\" field is required to be a valid email address"), $field);
                    break;
                case 'validate_max_len':
                    if($param == 1) {
                        $resp[] = sprintf(__("The \"%s\" field needs to be shorter than \"%s\" character"), $field, $param);
                    } else {
                        $resp[] = sprintf(__("The \"%s\" field needs to be shorter than \"%s\" characters"), $field, $param);
                    }
                    break;
                case 'validate_min_len':
                    if($param == 1) {
                        $resp[] = sprintf(__("The \"%s\" field needs to be longer than \"%s\" character"), $field, $param);
                    } else {
                        $resp[] = sprintf(__("The \"%s\" field needs to be longer than \"%s\" characters"), $field, $param);
                    }
                    break;
                case 'validate_exact_len':
                    if($param == 1) {
                        $resp[] = sprintf(__("The \"%s\" field needs to be exactly \"%s\" character in length"), $field, $param);
                    } else {
                        $resp[] = sprintf(__("The \"%s\" field needs to be exactly \"%s\" characters in length"), $field, $param);
                    }
                    break;
                case 'validate_alpha':
                    $resp[] = sprintf(__("The \"%s\" field may only contain alpha characters(a-z)"), $field);
                    break;
                case 'validate_alpha_numeric':
                    $resp[] = sprintf(__("The \"%s\" field may only contain alpha-numeric characters"), $field);
                    break;
                case 'validate_alpha_dash':
                    $resp[] = sprintf(__("The \"%s\" field may only contain alpha characters &amp; dashes"), $field);
                    break;
                case 'validate_numeric':
                    $resp[] = sprintf(__("The \"%s\" field may only contain numeric characters"), $field);
                    break;
                case 'validate_integer':
                    $resp[] = sprintf(__("The \"%s\" field may only contain a numeric value"), $field);
                    break;
                case 'validate_boolean':
                    $resp[] = sprintf(__("The \"%s\" field may only contain a true or false value"), $field);
                    break;
                case 'validate_float':
                    $resp[] = sprintf(__("The \"%s\" field may only contain a float value"), $field);
                    break;
                case 'validate_valid_url':
                    $resp[] = sprintf(__("The \"%s\" field is required to be a valid URL"), $field);
                    break;
                case 'validate_url_exists':
                    $resp[] = sprintf(__("The \"%s\" URL does not exist"), $field);
                    break;
                case 'validate_valid_ip':
                    $resp[] = sprintf(__("The \"%s\" field needs to contain a valid IP address"), $field);
                    break;
                case 'validate_valid_cc':
                    $resp[] = sprintf(__("The \"%s\" field needs to contain a valid credit card number"), $field);
                    break;
                case 'validate_valid_name':
                    $resp[] = sprintf(__("The \"%s\" field needs to contain a valid human name"), $field);
                    break;
                case 'validate_contains':
                    $resp[] = sprintf(__("The \"%s\" field needs to contain one of these values: \"%s\""), $field, implode(', ', $param));
                    break;
                case 'validate_containsList':
                    $resp[] = sprintf(__("The \"%s\" field needs contain a value from its drop down list"), $field);
                    break;
                case 'validate_doesNotContainList':
                    $resp[] = sprintf(__("The \"%s\" field contains a value that is not accepted"), $field);
                    break;
                case 'validate_street_address':
                    $resp[] = sprintf(__("The \"%s\" field needs to be a valid street address"), $field);
                    break;
                case 'validate_date':
                    $resp[] = sprintf(__("The \"%s\" field needs to be a valid date"), $field);
                    break;
                case 'validate_min_numeric':
                    $resp[] = sprintf(__("The \"%s\" field needs to be a numeric value, equal to, or higher than \"%s\""), $field, $param);
                    break;
                case 'validate_max_numeric':
                    $resp[] = sprintf(__("The \"%s\" field needs to be a numeric value, equal to, or lower than \"%s\""), $field, $param);
                    break;
                case 'validate_starts':
                    $resp[] = sprintf(__("The \"%s\" field needs to start with \"%s\""), $field, $param);
                    break;
                default:
                    $resp[] = sprintf(__("The \"%s\" field is invalid"), $field);
            }
        }
    ...
    public function get_errors_array($convert_to_string = null)
    {
        ...
        foreach($this->errors as $e) {
            ...
            switch($e['rule']) {
                case 'mismatch' :
                    $resp[$field] = sprintf(__("There is no validation rule for \"%s\""), $field);
                    break;
                case 'validate_required':
                    $resp[$field] = sprintf(__("The \"%s\" field is required"), $field);
                    break;
                case 'validate_valid_email':
                    $resp[$field] = sprintf(__("The \"%s\" field is required to be a valid email address"), $field);
                    break;
                case 'validate_max_len':
                    if($param == 1) {
                        $resp[$field] = sprintf(__("The \"%s\" field needs to be shorter than \"%s\" character"), $field, $param);
                    } else {
                        $resp[$field] = sprintf(__("The \"%s\" field needs to be shorter than \"%s\" characters"), $field, $param);
                    }
                    break;
                case 'validate_min_len':
                    if($param == 1) {
                        $resp[$field] = sprintf(__("The \"%s\" field needs to be longer than \"%s\" character"), $field, $param);
                    } else {
                        $resp[$field] = sprintf(__("The \"%s\" field needs to be longer than \"%s\" characters"), $field, $param);
                    }
                    break;
                case 'validate_exact_len':
                    if($param == 1) {
                        $resp[$field] = sprintf(__("The \"%s\" field needs to be exactly \"%s\" character in length"), $field, $param);
                    } else {
                        $resp[$field] = sprintf(__("The \"%s\" field needs to be exactly \"%s\" characters in length"), $field, $param);
                    }
                    break;
                case 'validate_alpha':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain alpha characters(a-z)"), $field);
                    break;
                case 'validate_alpha_numeric':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain alpha-numeric characters"), $field);
                    break;
                case 'validate_alpha_dash':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain alpha characters &amp; dashes"), $field);
                    break;
                case 'validate_numeric':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain numeric characters"), $field);
                    break;
                case 'validate_integer':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain a numeric value"), $field);
                    break;
                case 'validate_boolean':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain a true or false value"), $field);
                    break;
                case 'validate_float':
                    $resp[$field] = sprintf(__("The \"%s\" field may only contain a float value"), $field);
                    break;
                case 'validate_valid_url':
                    $resp[$field] = sprintf(__("The \"%s\" field is required to be a valid URL"), $field);
                    break;
                case 'validate_url_exists':
                    $resp[$field] = sprintf(__("The \"%s\" URL does not exist"), $field);
                    break;
                case 'validate_valid_ip':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to contain a valid IP address"), $field);
                    break;
                case 'validate_valid_cc':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to contain a valid credit card number"), $field);
                    break;
                case 'validate_valid_name':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to contain a valid human name"), $field);
                    break;
                case 'validate_contains':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to contain one of these values: \"%s\""), $field, implode(', ', $param));
                    break;
                case 'validate_street_address':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to be a valid street address"), $field);
                    break;
                case 'validate_date':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to be a valid date"), $field);
                    break;
                case 'validate_min_numeric':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to be a numeric value, equal to, or higher than \"%s\""), $field, $param);
                    break;
                case 'validate_max_numeric':
                    $resp[$field] = sprintf(__("The \"%s\" field needs to be a numeric value, equal to, or lower than \"%s\""), $field, $param);
                    break;
                default:
                    $resp[$field] = sprintf(__("The \"%s\" field is invalid"), $field);
            }
        }

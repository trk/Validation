...
class GUMP
{
	...
	{
        $rules = (array_key_exists('Rules', $validators)) ? $validators['Rules'] : $validators;
        $labels = (array_key_exists('Labels', $validators)) ? $validators['Labels'] : array();
	...
	{
		return $this->get_readable_errors($options = array('toString' => true));
	}
